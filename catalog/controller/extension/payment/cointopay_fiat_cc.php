        ...
        try {
            ...
            if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
                ...
                if ($php_arr->error == '' || empty($php_arr->error)) {
                    $this->model_checkout_order->addOrderHistory($php_arr->CustomerReferenceNr, $this->config->get('payment_cointopay_fiat_cc_order_status_id'));
            ...
            if (200 !== $transactionData['status_code']) {
                ...
                if ($transactionData['data']['Security'] != $_GET['ConfirmCode']) {
                    ...
                    if ($_REQUEST['status'] == 'paid') {
                        ...
                        $this->model_checkout_order->addOrderHistory($_REQUEST['CustomerReferenceNr'], $this->config->get('payment_cointopay_fiat_cc_callback_success_order_status_id', 'Successfully Paid'));
                        ...
                        $this->model_checkout_order->addOrderHistory($_REQUEST['CustomerReferenceNr'], $this->config->get('payment_cointopay_fiat_cc_callback_failed_order_status_id', 'Transaction payment failed'));
