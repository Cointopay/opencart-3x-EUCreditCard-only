<?php
class ModelExtensionPaymentCoinToPayFiatCC extends Model {
	public function getMethod($address, $total) {
		$this->load->language('extension/payment/cointopay_fiat_cc');

        $method_data = array(
            'code'       => 'cointopay_fiat_cc',
            'title'      => $this->config->get('payment_cointopay_fiat_cc_display_name'),
            'terms'      => '',
            'sort_order' => $this->config->get('payment_cointopay_fiat_cc_sort_order')
        );
